...
public class SprdUsbSettingsFragment extends SettingsPreferenceFragment
    ...
    private final static boolean SUPPORT_MIDI = false;
    private final static boolean SUPPORT_CDROM = false;
    ...
    private void updateUI() {
        ...
        //mdm
        if(com.jingos.mdm.MdmPolicyIntercept.UsbDataIntercept_Intercept(getActivity()))
        {
