...
public class FingerprintSettings extends SubSettings {
    ...
    public static class FingerprintSettingsFragment extends SettingsPreferenceFragment
        ...
        private void showRenameDialog(final Fingerprint fp) {
            RenameDialog renameDialog = new RenameDialog(mFingerprintManager,mUserId);
        ...
        public static class RenameDialog extends InstrumentedDialogFragment {
            ...
            private int mUserId;
            public RenameDialog(FingerprintManager fm,int id){
                mFM=fm;
                mUserId=id;
            }
                        ...
                        .setPositiveButton(R.string.security_settings_fingerprint_enroll_dialog_ok,
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        final List<Fingerprint> items = mFM.getEnrolledFingerprints(mUserId);
                                        if (items != null) {
                                            for (Fingerprint fp : items) {
                                                if (newName != null && fp.getName().equals(newName) && mFp.getBiometricId() != fp.getBiometricId()) {
                                                    Toast.makeText(getActivity(), R.string.fingerprint_name_repeat, Toast.LENGTH_LONG).show();
                                                    return;
                                                }
                                            }
                                        }
                    ...
                    public void onShow(DialogInterface dialog) {
                        ...
                        mDialogTextField.addTextChangedListener(new TextWatcher() {
                            ...
                            public void afterTextChanged(Editable s) {
                                ...
                                if(TextUtils.isEmpty(content) || TextUtils.isEmpty(tmpStr)) {
                                    mPositiveButton.setEnabled(false);
                                } else {
                                    mPositiveButton.setEnabled(true);
                                }                    }
