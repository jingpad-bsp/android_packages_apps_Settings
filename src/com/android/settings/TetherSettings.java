...
public class TetherSettings extends RestrictedSettingsFragment
    ...
    private boolean mUsbTetherShare;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mRadioInteractor = new RadioInteractor(getContext());
    ...
    private void updateUsbState(String[] available, String[] tethered,
        ...
        if (mCm.getPCNetTether()) {
            ...
            if (mUsbTetherShare) {
                mRadioInteractor.setUsbShareStateSwitch(0, false);
            }
            mUsbTetherShare = false;
            ...
            if (!mUsbTetherShare) {
                mRadioInteractor.setUsbShareStateSwitch(0, true);
            }
            mUsbTetherShare = true;
